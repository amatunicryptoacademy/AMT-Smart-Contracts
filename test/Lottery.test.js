...
describe("Lottery", function () {
	let deployer, caller, vzgo, grno, signer, lottery, amatik, amount;
	...
	beforeEach(async function () {
		...
		console.log(await lottery._split(BigNumber.from("101253252927102610542851450324291093105123828566876990403045484632854127021779"), {gasLimit: 500000}));
	});
	...
	describe("Create new lotto", function () {
	...
	describe("End of lottery", function () {
		it("Should buy tickets and claim the reward", async function () {
			amount = await lottery.getTokenAmountForCurrentPrice(5);
			const blockNumber = await ethers.provider.getBlockNumber();
			await lottery.createNewLotto([3000, 1500, 500], blockNumber + 1, 5, 9);
